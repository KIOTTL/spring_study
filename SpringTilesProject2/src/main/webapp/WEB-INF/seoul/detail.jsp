  ...
  <div class="container">
    <div class="row">
      <table class="table">
        <tr>
          <td>
            <img src="${vo.poster }" style="width: 800px; height: 550px;">
          </td>
        </tr>
        <tr>
          <td>
                ...
                <tr style="display: none" id="u${rvo.no }" class="updates">
	              <td>
	                <form method="post" action="../reply/update.do">
	                  <textarea rows="4" cols="80" style="float: left" name="msg">${rvo.msg }</textarea>
	                  <input type="hidden" name="no" value="${rvo.no }">
	                  <input type="hidden" name="cno" value="${vo.no }">
	                  <input type="hidden" name="type" value="${tab }">
	                  <input type=submit value="댓글수정" class="btn btn-sm btn-danger" style="height: 85px; float: left">
	                </form>
	              </td>
	            </tr>
              </table>
          ...
          <tr>
            <td>
              <form method="post" action="../reply/insert.do">
                <textarea rows="4" cols="93" style="float: left" name="msg"></textarea>
                <input type="hidden" name="cno" value="${vo.no }">
                <input type="hidden" name="type" value="${tab }">
                <input type=submit value="댓글쓰기" class="btn btn-sm btn-danger" style="height: 85px; float: left">
              </form>
            </td>
          </tr>
        </table>

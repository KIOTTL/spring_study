  ...
  <div class="container">
    ...
    <div class="col-sm-7">
      <table class="table">
        ...
        <tr>
          <th class="default" width=20%>음식 종류</th>
  ...
  <script>
    new Vue({
    	...
    	mounted:function(){
    		...
    		//script.
    		onload=()=>kakao.maps.load(this.initMap());
    		...
    		initMap:function(){
    		    ...
    		    if (status === kakao.maps.services.Status.OK) {
    		        ...
    		        var infowindow = new kakao.maps.InfoWindow({
    		            content: '<div style="width:150px;text-align:center;padding:6px 0;">'+this.food_detail+'</div>'
    		        });

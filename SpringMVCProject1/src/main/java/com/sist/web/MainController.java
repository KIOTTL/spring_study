...
public class MainController {
	...
	public String main_output1(String name, String sex, String loc, String content, String[] hobby, Model model) {
		// Model ==> 데이터 전송 객체 (request 첨부)
		// request를 사용하지 않고 매개변수를 이용해 데이터를 DispatcherServlet으로부터 받을 수 있다
		// request, response를 사용하지 않고 매개변수를 이용해 데이터값을 받는다
		/*
		 * 	request 사용 ==> Cookie

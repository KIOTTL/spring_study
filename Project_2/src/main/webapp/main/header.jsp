  ...
  <nav class="u-menu u-menu-one-level u-offcanvas u-menu-1" style="margin-right: 50px;">
    <div class="u-custom-menu u-nav-container">
      <ul class="u-nav u-unstyled u-nav-1">
        <li class="u-nav-item"><a class="u-button-style u-nav-link u-text-active-palette-1-base u-text-hover-palette-2-base" href="../mypage/mypage.do" style="padding: 10px 10px; font-weight: 700; font-size: 15px;">프로젝트 올리기</a></li>
      ...
      <div class="u-black u-container-style u-inner-container-layout u-opacity u-opacity-95 u-sidenav">
        <div class="u-inner-container-layout u-sidenav-overflow">
          ...
          <ul class="u-align-center u-nav u-popupmenu-items u-unstyled u-nav-2">
            <li class="u-nav-item"><a class="u-button-style u-nav-link" href="../mypage/mypage.do" >프로젝트 올리기</a></li>
